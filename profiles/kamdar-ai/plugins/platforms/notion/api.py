...
try:
    ...
    from agent.secret_scope import get_secret as scoped_get_secret
except ModuleNotFoundError:  # Direct unit tests outside the Hermes runtime.
    class UnscopedSecretError(RuntimeError):
        pass

    def scoped_get_secret(name: str, default: str = "") -> str:
...
def _setting(name: str, default: str = "") -> str:
    ...
    try:
        value = scoped_get_secret(name, default)
