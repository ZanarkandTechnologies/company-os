...
class WebhookState:
    ...
    def remember_reply_target(self, comment_id: str, discussion_id: str) -> bool:
        """Persist the reply destination while the ticket page owns session identity."""
        ...
        targets[comment_id] = {"discussion_id": discussion_id, "saved_at": self.now()}
