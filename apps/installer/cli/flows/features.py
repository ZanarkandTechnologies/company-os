...
QUESTIONS = (
    Question("weekly.conversations", "Weekly · Work conversations", "Should weekly reviews include work conversations?", "Personal ChatGPT uses member-selected submissions. Local Codex reads only configured repository folders on an authorized device. Set up the private intake policy first; enabling this pilot keeps weekly outputs local. Central Enterprise/Edu collection is not available in this release.", (Preset("Disabled", "Use existing project and task sources only.", "Conversation context is disabled. Do not read conversation sources."), Preset("Selected ChatGPT conversations", "Read private member-submitted weekly evidence.", "Read optional conversation evidence through `conversation_read_project_week` using the operator-configured private intake policy. Enable only chatgpt_manual bindings."), Preset("Local Codex conversations", "Read retained conversations for explicitly configured repositories.", "Read optional conversation evidence through `conversation_read_project_week` using the operator-configured private intake policy. Enable only codex_local or codex_manual bindings."), Preset("ChatGPT and Codex", "Combine member submissions and scoped local Codex evidence.", "Read optional conversation evidence through `conversation_read_project_week` using the operator-configured private intake policy. Enable chatgpt_manual, codex_local or codex_manual bindings as explicitly configured.")), "Describe which supported intake sources should be enabled; this cannot enable Enterprise collection"),
