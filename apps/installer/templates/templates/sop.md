---
{"output":"templates/sop.md","runtime":{"template_id":"company-os-employee-sop","template_version":"1.3.0","name":"{{SOP_NAME}}","sop_id":"{{SOP_ID}}","workflow_key":"{{WORKFLOW_KEY}}","projects":"{{PROJECTS}}","department":"{{DEPARTMENT}}","owner":"{{OWNER}}","status":"{{STATUS}}","baseline_version":"{{BASELINE_VERSION}}","record_version":"{{RECORD_VERSION}}","effective_date":"{{EFFECTIVE_DATE}}","last_reviewed":"{{LAST_REVIEWED}}","next_review":"{{NEXT_REVIEW}}"},"refs":["organization.grouping"]}
---
