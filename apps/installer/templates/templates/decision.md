---
{"output":"templates/decision.md","runtime":{"template_id":"company-os-decision","template_version":"0.6.0","name":"{{DECISION}}","decision_id":"{{DECISION_ID}}","project":"{{PROJECT}}","department":"{{DEPARTMENT}}","proposer":"{{PROPOSER}}","approver":"{{APPROVER}}","status":"{{STATUS}}","decided_at":"{{DECIDED_AT}}","review_date":"{{REVIEW_DATE}}"},"refs":["organization.grouping"]}
---
