---
{"output":"skills/pm-weekly/templates/weekly-report.md","refs":["organization.grouping"]}
---

---
template_id: "company-os-weekly-report"
template_version: "2.1.0"
name: "{{${unit_upper}_NAME}} — Week of {{WEEK_START}}"
report_type: "${unit}"
...
# {{${unit_upper}_NAME}} — Week of {{WEEK_START}}
