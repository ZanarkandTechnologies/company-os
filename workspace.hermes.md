...
company_description: "A company configuring Company OS."
...
| --- | --- | --- | --- | --- |
| `projects` | — | — | read-write | Human-operated project source records; private derived management state stays in the Hermes weekly workspace |
| `tasks` | — | — | read-write | Current work items linked to projects |
| `people` | — | — | read | People referenced by configured work only |
| `sops` | — | — | read | Approved source SOPs and operating procedures |
| `reports` | — | — | read | Historical company and department reports used as evidence |
| `operator_email` | — | — | isolated-eval | Operator-owned inbox used only for bounded connection certification |
<!-- /hermes:managed data-sources -->
